...
- `#政策` `#签证` `#安全` — 正规硬新闻
- `#政治` — 组阁进展、政党动态
- `#经济数据` — GDP、通胀、泰铢汇率、利率等宏观数据（专用tag，用于降频）
- `#楼市大盘` — 泰国整体房产市场趋势报告（专用tag，用于降频）
- `#新楼盘` — 具体楼盘开售/封顶/预告/促销（对外国买家有实用价值）
- `#房产` `#开发商` — 其他房地产动态
- `#AI基建` — 数据中心、AI算力、电力基建、云计算在泰国的投资与建设
- `#AI应用` — AI在泰国政府、教育、医疗、商业、民间的实际应用案例
- `#科技` — 其他科技动态
- `#本地奇闻` — 有趣、奇特、反常的泰国本地社会新闻，有故事性
- `#治安犯罪` — 刑事案件、诈骗、社会治安
- `#旅游` — 旅游景点、观光资讯
- `#PR软文` — 明显的公关稿/开发商通稿
- `#品牌` — 品牌活动、企业公告
- `#活动促销` — 旅游促销、节日活动、优惠信息
- `#追踪` — 已有事件的新进展
- `#中泰` — 中泰关系、中国投资、中国游客/移民政策

**重要性分级（P级）——注意以下调整：**
- P1：影响外国人的政策/签证/安全、重大突发事件、追踪议题重要进展
- P2：政治重大变化、科技基建落地、具体楼盘动态（#新楼盘）、本地有料奇闻（#本地奇闻）、AI泰国相关（#AI基建 #AI应用）
- P3：常规经济数据（#经济数据）、楼市趋势报告（#楼市大盘）、组阁例行进展（#政治 无重大变化）、旅游促销、社会犯罪

**降频说明（影响50条截取时的优先级）：**
- `#经济数据`、`#楼市大盘`、`#政治`（例行进展）→ 同等重要性下排后，每天最多各入库2条
- `#新楼盘`、`#本地奇闻`、`#AI基建`、`#AI应用` → 同等重要性下优先入库
